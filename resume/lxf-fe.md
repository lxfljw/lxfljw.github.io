...
- 近 2 年具备全栈实践经验，熟悉 Spring Boot、MySQL、Redis、NSQ 等后端技术，可独立推进前后端联调与部分服务端开发。
...
- 维护业务组件库、小程序非侵入式埋点、动态主题等通用能力，推进工程化基线与小程序 DevOps 建设。
...
- 负责秦丝 SaaS 进销存系统 Web、小程序及混合 App 业务开发，主导小程序首页装修系统从 0 到 1 落地。
...
- **小红书小程序**：在 3 个月内基于 UniApp 独立完成前端从 0 到 1 建设，覆盖商品配置、详情、支付及订单等核心交易页面；并参与部分 Spring Boot 后端开发，负责商品提审、POI 绑定等能力，上线后负责全部前后端维护。
- **权益过期与标签刷新**：参与后端方案设计及 Java 实现，通过 MySQL 增量查询、分批聚合与 **NSQ** 消息通知业务方完成标签更新，以增量处理替代全量重算。

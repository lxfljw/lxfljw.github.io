...
- 负责美业 SaaS 前端业务与部分服务端开发，主导 CRM 定制化及工程效能治理。
- 主导 dev-flow MCP Server 建设，并支持一键配置到主流 AI 客户端。
...
- **腾讯 IM 客服**：在 H5 与小程序接入腾讯云 IM，支持客户订单、商品信息快速查询；并完成 B 端客服页面开发，打通客服接待与业务数据查询能力。
